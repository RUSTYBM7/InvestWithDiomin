...
import CreditBridge from "./pages/CreditBridge";
...
function App() {
  useEffect(() => {
    const key = "pinterest-imported-session";
    if (!sessionStorage.getItem(key)) {
      // Mock fetch since backend doesn't exist
      console.log("Mocking pinterest import fetch");
          ...
          <Router>
            ...
            <AuthProvider>
              <Routes>
                ...
                <Route path="/services/credit-bridge" element={<><Navigation /><Breadcrumbs /><CreditBridge /></>} />
                <Route path="/services/institutional" element={<><Navigation /><Breadcrumbs /><Institutional /></>} />
                {/* Insights */}
